...
function Home() {
  return (
    <section className="bg-hero-img bg-cover">
      <container className="flex h-screen flex-col bg-primary-300/85 px-4 py-4 backdrop-blur-sm md:flex-row lg:px-10">
        <div
          className="to-blue-500py-6 z-10 flex h-full w-full flex-col items-center justify-center gap-2 px-4 text-left sm:gap-1 md:items-start lg:items-end"
          data-aos="fade-down-right"
        >
          <h4 className="text-lg uppercase tracking-wide text-shade-300 sm:text-2xl md:text-xl lg:text-3xl">
            hello there!
          </h4>
          <h1 className="font-[Yesteryear] text-5xl font-normal text-white sm:text-6xl md:text-6xl lg:pt-4 lg:text-8xl">
            I&apos;m Noah
          </h1>
        ...
        <div
          className="order-first flex h-full w-full items-center justify-center md:order-2 lg:justify-start lg:pl-10"
